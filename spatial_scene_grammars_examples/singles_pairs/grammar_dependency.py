...
class Pairs(RepeatingSetNode):
    ...
    def __init__(self, tf):
        super().__init__(
            tf=tf,
            rule_probs=RepeatingSetNode.get_geometric_rule_probs(p=self.P, max_children=self.MAX_N_PAIRS),
            physics_geometry_info=None,
            observed=False
        )
    @classmethod
...
class Singles(RepeatingSetNode):
    ...
    def __init__(self, tf):
        super().__init__(
            tf=tf,
            rule_probs=RepeatingSetNode.get_geometric_rule_probs(p=self.P, max_children=self.MAX_N_SINGLES),
            physics_geometry_info=None,
            observed=False
        )
    @classmethod
